...
class EventData {
  ...
  factory EventData.fromJson(Map<String, dynamic> json) => EventData(
    ...
    eventActivityChoiceTags: json["event_activity_choice_tags"] == null ? [] : List<EventMusicChoiceTag>.from(json["event_activity_choice_tags"]!.map((x) => EventMusicChoiceTag.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "music_genre": musicGenre == null ? [] : List<dynamic>.from(musicGenre!.map((x) => x)),
    "event_music_choice_tags": eventMusicChoiceTags == null ? [] : List<dynamic>.from(eventMusicChoiceTags!.map((x) => x.toJson())),
    "event_activity_choice_tags": eventActivityChoiceTags == null ? [] : List<dynamic>.from(eventActivityChoiceTags!.map((x) => x)),
  };
}
...
class ProfilePicture {
  ...
  factory ProfilePicture.fromJson(Map<String, dynamic> json) => ProfilePicture(
    ...
    mediaFor: json["media_for"],
    thumbnail: json["thumbnail"],
    mediaPath: json["media_path"] ==null?null:Url().imageUrl+json["media_path"],
    mediaType: json["media_type"],
    galleryableType: json["galleryable_type"],
    galleryableId: json["galleryable_id"],
    createdAt: json["created_at"],
