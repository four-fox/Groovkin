              ...
              height: kToolbarHeight*3,
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text("Attended by 500 people",
                        style: poppinsRegularStyle(fontSize: 10,color: theme.primaryColor,context: context),
                      ),
                    ),
                  ),
                ),
                ...
                // }):SizedBox.shrink(),
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text("90’s Grunge and Bowling",
                  ...
                  venueService(theme: theme,context: context,bgColor: DynamicColor.darkBlueClr,
                  ...
                  sp.read('role')=="eventManager"?SizedBox.shrink(): Obx(() =>
                      aboutEventCreator(theme: theme,context: context,
                          followBg:organizerFollowVal.value==true?DynamicColor.lightWhite: DynamicColor.avatarBgClr,
                  ...
                  sp.read('role')=="eventOrganizer"?SizedBox.shrink(): Obx(() => ourGuestWidget(theme: theme,context: context,horizontalPadding: 0.0,
                    rowPadding: 0.0,
                    rowVerticalPadding: 0.0,
                    avatarPadding: 6,
                    followBgClr:organizerFollowValue.value==true?DynamicColor.grayClr: DynamicColor.avatarBgClr,
                    icon: organizerFollowValue.value ==true?Icons.check:Icons.add,
                    textClr: organizerFollowValue.value !=true?theme.primaryColor:theme.scaffoldBackgroundColor,
                    followOnTap: () {
                      organizerFollowValue.value = !organizerFollowValue.value;
                    },
                    onTap: (){
                      // Get.toNamed(Routes.eventOrganizerScreen,
                      //     arguments: {
                  ...
                  Padding(
                    ...
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: Text("Herkimer County Fairgrounds",
                        style: poppinsRegularStyle(
                          fontSize: 15,
                          context: context,
                          color: theme.primaryColor,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      CircleAvatar(
                        radius: 17,
                        backgroundColor: DynamicColor.avatarBgClr,
                        child: Image(image: AssetImage("assets/lighting.png"),
                        ),
                      ),
                        Padding(
                          padding: EdgeInsets.only(left: 8.0),
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 17,
                          backgroundColor: DynamicColor.avatarBgClr,
                          child: Image(image: AssetImage("assets/photobooth.png"),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.only(left: 8.0),
                  ...
                  Padding(   padding: EdgeInsets.symmetric(horizontal: 12.0,vertical: 10),
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 17,
                          backgroundColor: DynamicColor.avatarBgClr,
                          child: Image(image: AssetImage("assets/master.png"),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.only(left: 8.0),
                          child: Text("Master of Ceremony",
                            style: poppinsMediumStyle(
                                fontSize: 16,
                                color: theme.primaryColor,
                                context: context
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 17,
                          backgroundColor: DynamicColor.avatarBgClr,
                          child: Image(image: AssetImage("assets/avEquipment.png"),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.only(left: 8.0),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text('Reason of cancellation',
                style: poppinsMediumStyle(
                  fontSize: 17,
                  context: context,
                  color: theme.primaryColor,
