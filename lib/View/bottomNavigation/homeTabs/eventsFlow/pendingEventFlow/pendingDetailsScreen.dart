      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            if (controller.eventDetail!.data!.user!.isDelete !=
                                null)
                            ...
                            CircleAvatar(
                              ...
                              backgroundImage:
                                  controller.eventDetail!.data!.bannerImage ==
                                          null
                                      ? null
                                      : NetworkImage(controller.eventDetail!
                                          .data!.bannerImage!.mediaPath!),
                            ),
                            Padding(
                                  ...
                                  children: [
                                    ...
                                    if (sp.read("role") == "eventManager" &&
                                      ...
                                      CustomButton(
                                        ...
                                        color2: controller.eventDetail!.data!
                                                    .user!.isDelete ==
                                                null
                                            ? DynamicColor.greenClr
                                                .withValues(alpha: 0.8)
                                            : DynamicColor.disabledColor,
                                        color1: controller.eventDetail!.data!
                                                    .user!.isDelete ==
                                                null
                                            ? DynamicColor.greenClr
                                                .withValues(alpha: 0.8)
            ...
            customWidget(context, theme,
                title: "Price",
                value: controller.eventDetail!.data!.balanceDue.toString()),
            customWidget(context, theme,
                title: "Rating",
                        ...
                        : controller.eventDetail!.data!.venue != null
                            ? aboutEventCreator(
                                ...
                                textClr: controller.eventDetail!.data!.venue!.user!.following == null
                                    ...
                                    : theme.primaryColor,
                                text: controller.eventDetail!.data!.venue!.user!
                                    .profile!.about
                                    .toString(),
                                followText:
                                    controller.eventDetail!.data!.venue!.user!.following == null
                                        ...
                                        : "Unfollow",
                                onTap: () {
                                  if (controller.eventDetail!.data!.venue!.user!
                                          .following ==
                                      null) {
                        ...
                        : ourGuestWidget(
                            ...
                            onTap: () {
                              Get.toNamed(Routes.viewProfileScreen, arguments: {
                                ...
                                "eventId": controller.eventDetail!.data!.userId
                              });
                            },
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Align(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount:
                                controller.eventDetail!.data!.services!.length,
                    ...
                    Align(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, index) {
                            final filterItem = controller.eventDetail!.data!
                    ...
                    if (controller.eventDetail!.data!.musicGenre!.any((genre) =>
                    ...
                    Align(
                      ...
                      child: ListView.builder(
                          ...
                          physics: const NeverScrollableScrollPhysics(),
                          itemCount:
                              controller.eventDetail!.data!.musicGenre!.length,
                          itemBuilder: (BuildContext context, index) {
                            final filterItem = controller.eventDetail!.data!
                    ...
                    Align(
                      ...
                      child: ListView.builder(
                          padding: EdgeInsets.zero,
                          itemCount: controller
                              .eventDetail!.data!.eventMusicChoiceTags!.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemBuilder: (BuildContext context, index) {
                            final filterItem = controller
                                ...
                                .musicChoiceItems!
                                .categoryItems!
                                .where((data) => data.userSelection == true)
                                .toList();
                            if (filterItem.isEmpty) return SizedBox();
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
