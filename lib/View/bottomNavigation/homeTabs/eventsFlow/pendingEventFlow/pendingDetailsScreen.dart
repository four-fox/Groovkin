  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: customAppBar(theme: theme,text: titleText, actions: [
        flowBtn==1? Icon(Icons.more_vert,
      ...
      body: GetBuilder<EventController>(
        ...
        builder: (controller) {
          return controller.eventDetailsLoader.value == false?SizedBox.shrink():
          Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                   radius: 25,
                                   backgroundImage:controller.eventDetail!.data!.bannerImage == null?null: NetworkImage(controller.eventDetail!.data!.bannerImage!.mediaPath!),
                                  ),
                                  Padding(
                          ...
                          flowBtn !=1 ? Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomButton(
                                  heights: 35,
                                  color2: DynamicColor.redClr.withOpacity(0.8),
                                  color1: DynamicColor.redClr.withOpacity(0.8),
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text('i have read and agree to the terms and\nconditions',
                                                              style: poppinsRegularStyle(
                                                                fontSize: 13,
                                                                context: context,
                                                                color: theme.primaryColor,
                                                      ...
                                                      CustomButton(
                                                        ...
                                                        color2: DynamicColor.greenClr.withOpacity(0.8),
                                                        color1:DynamicColor.greenClr.withOpacity(0.8),
                          ...
                          Padding(
                            ...
                            CustomButton(
                              heights: 39,
                              widths:/*flowBtn==1? Get.width/1.5:*/Get.width/1.135,
                              style: poppinsMediumStyle(
                                  fontSize: 13,
                                  context: context,
                                  color: theme.primaryColor,
                          ...
                          (API().sp.read("role") == "eventOrganizer" && controller.eventDetail!.data!.isCounterActive!.value == 0)?SizedBox.shrink():  Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 8.0),
                            child: CustomButton(
                              heights: 39,
                              onTap: (){
                                int? userId;
                                if(controller.eventDetail!.data!.userId == API().sp.read("userId")){
                                  userId = controller.eventDetail!.data!.venue!.userId;
                                }else{
                                  userId = controller.eventDetail!.data!.userId!;
                                }
                          ...
                          flowBtn==1?SizedBox.shrink():   Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 8.0),
                            child: CustomButton(
                              heights: 39,
                              style: poppinsMediumStyle(
                  ...
                  Padding(
                    ...
                    child: Text(controller.eventDetail!.data!.eventTitle!,
                    style: poppinsMediumStyle(
                      fontSize: 19,
                      context: context,
                      color: theme.primaryColor,
                  ...
                  venueService(
                    ...
                    text: "${DateFormat.jm().format(controller.eventDetail!.data!.startDateTime!)} to ${DateFormat.jm().format(controller.eventDetail!.data!.endDateTime!)}",
                    icon: true,
                  ),
                  venueService(
                    theme: theme,
                    ...
                    text: DateFormat.yMMMMEEEEd().format(controller.eventDetail!.data!.startDateTime!),
                    icon: true,
                  ),
                  venueService(
                    theme: theme,
                ...
                theme: theme,context: context,horizontalPadding: 0.0,rowPadding: 0.0,avatarPadding: 6,rowVerticalPadding: 0.0,
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text(controller.eventDetail!.data!.location!,
                      style: poppinsMediumStyle(
                          fontSize: 13,
                          context: context,
                          color: theme.primaryColor,
                  ...
                  ShowCustomMap(horizontalPadding: 2,
                          ...
                          child: Align(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context,indx){
                                  return customList(context: context, theme: theme,name: controller.eventDetail!.data!.services![indx].eventItem!.name.toString());
                                }),
                          ),
                        ),
                        SizedBox(
