...
class MusicChoiceScreen extends StatelessWidget {
  MusicChoiceScreen({Key? key}) : super(key: key);
...
class ActivityChoiceScreen extends StatelessWidget {
  ActivityChoiceScreen({Key? key}) : super(key: key);
...
class SaveHashTagScreen extends StatelessWidget {
  SaveHashTagScreen({Key? key}) : super(key: key);
  EventController _controller = Get.find();
                ...
                Wrap(
                  children: <Widget>[
                    Chip(
                        ...
                        backgroundColor: DynamicColor.whiteClr,
                        label: Text("#Pooltable",style: poppinsRegularStyle(
                          fontSize: 12,
                          context: context,
                          color: theme.scaffoldBackgroundColor,
                        ),)),
                    Padding(
                      ...
                      child: Chip(
                          ...
                          backgroundColor: DynamicColor.whiteClr,
                          label: Text("#Billiards",style: poppinsRegularStyle(
                            fontSize: 12,
                            context: context,
                            color: theme.scaffoldBackgroundColor,
                          ),)),
                    ...
                    Chip(
                        ...
                        backgroundColor: DynamicColor.whiteClr,
                        label: Text("#Tequla",style: poppinsRegularStyle(
                          fontSize: 12,
                          context: context,
                          color: theme.scaffoldBackgroundColor,
                        ),)),
                    Padding( padding: EdgeInsets.symmetric(horizontal: 5.0),
                      child: Chip(
                          ...
                          backgroundColor: DynamicColor.whiteClr,
                          label: Text("#8Ball",style: poppinsRegularStyle(
                            fontSize: 12,
                            context: context,
                            color: theme.scaffoldBackgroundColor,
                          ),)),
                    ...
                    Chip(
                        ...
                        backgroundColor: DynamicColor.whiteClr,
                        label: Text("#TacoTuesday",style: poppinsRegularStyle(
                          fontSize: 12,
                          context: context,
                          color: theme.scaffoldBackgroundColor,
                        ),)),
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(listA[index].text.toString(),
                                    style: poppinsRegularStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600,
                                      context: context,
...
class CreateNewHashTagScreen extends StatelessWidget {
 CreateNewHashTagScreen({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      style: poppinsRegularStyle(fontSize: 14,color: theme.primaryColor,
                      context: context),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Chip(
                          ...
                          backgroundColor: DynamicColor.whiteClr,
                          label: Text(i,style: poppinsRegularStyle(
                            fontSize: 12,
                            context: context,
                            color: theme.scaffoldBackgroundColor,
                          ),)),
