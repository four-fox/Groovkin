                                                                  ...
                                                                  child: Checkbox(
                                                                      ...
                                                                      onChanged: (v) {
                                                                        controller.tagAddFtn(
                                                                            items:
                                                                                controller.tagList[index].categoryItems![indexess],
                                                                            value: v);
                                                                      }),
                                                                )
                                                              ],
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Theme(
                                                                  ...
                                                                  child: Checkbox(
                                                                      activeColor: DynamicColor.yellowClr,
                                                                      value: controller.activityList[index].categoryItems![indexess].selected!.value,
                                                                      onChanged: (v) {
                                                                        controller.activityAddFtn(
                                                                            items:
                                                                                controller.activityList[index].categoryItems![indexess],
                                                                            value: v);
                                                                      }),
                                                                )
                                                              ],
