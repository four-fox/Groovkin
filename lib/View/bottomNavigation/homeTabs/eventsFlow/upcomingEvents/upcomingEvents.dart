                    ...
                    Visibility(
                      ...
                      child: controller.upcomingEventData == null ||
                          ...
                          : Column(
                              children: [
                                ListView.builder(
                                    itemCount: controller.upcomingEventData!
                                                .data!.data!.length >
                                            4
                                        ? 4
                                        : controller.upcomingEventData!.data!
                                            .data!.length,
                                    shrinkWrap: true,
                                      ...
                                      return userCustomEvent(
                                          ...
                                          img:
                                              singleEventDat
                                                  ...
                                                  .toString(),
                                          title: singleEventDat
                                              .eventTitle
                                              .toString(),
                                          location: singleEventDat.location,
                                          subtitle: singleEventDat
                                              .venue!.venueName
                                              .toString(),
                                          onTap: () {
                                            recommendedVal.value = false;
                    ...
                    Visibility(
                      ...
                      child: controller.ongoingEvents == null ||
                          ...
                          : Column(
                              children: [
                                ListView.builder(
                                    itemCount: controller.ongoingEvents!.data!
                                                .data!.length >
                                            4
                                        ? 4
                                        : controller
                                    ...
                                    itemBuilder: (BuildContext context, index) {
                                      ...
                                      return userCustomEvent(
                                          ...
                                          img: singleEvent
                                              ...
                                              .toString(),
                                          title:
                                              singleEvent.eventTitle.toString(),
                                          location: singleEvent.location,
                                          subtitle: singleEvent.venue!.venueName
                                              .toString(),
                                          onTap: () {
                                            ongoingVal.value = false;
                                            Get.toNamed(Routes.upcomingScreen,
