...
class UpcomingEvents extends StatelessWidget {
  ...
  Padding _ongoingMethod(
      BuildContext context, ThemeData theme, EventController controller) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 10.0),
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              ...
              child: controller.ongoingEvents == null ||
                  ...
                  : Column(
                      children: [
                        ListView.builder(
                            itemCount:
                                controller.ongoingEvents!.data!.data!.length > 4
                                    ? 4
                                    : controller
                            ...
                            itemBuilder: (BuildContext context, index) {
                              ...
                              return userCustomEvent(
                                  isDelete: singleEvent.user!.isDelete == null
                                      ...
                                      : true,
                                  dayy: DateFormat.MMM()
                                      .format(singleEvent.startDateTime!),
                                  datee: "${singleEvent.startDateTime!.day}\n",
                                  networkImg: singleEvent.bannerImage == null
                                      ? false
                                      : true,
                                  img: singleEvent.bannerImage?.mediaPath
                                      .toString(),
                                  title: singleEvent.eventTitle.toString(),
                                  location: singleEvent.location,
                                  subtitle:
                                      singleEvent.venue!.venueName.toString(),
                                  onTap: () {
                                    ongoingVal.value = false;
                                    Get.toNamed(Routes.upcomingScreen,
                                        arguments: {
        ...
        child: Column(
          children: [
            ...
            Visibility(
              ...
              child: controller.upcomingEventData == null ||
                      ...
                      children: [
                        ListView.builder(
                            itemCount: controller
                                        .upcomingEventData!.data!.data!.length >
                                    4
                                ? 4
                                : controller
                                    .upcomingEventData!.data!.data!.length,
                            ...
                            itemBuilder: (BuildContext context, index) {
                              ...
                              return userCustomEvent(
                                  ...
                                  networkImg: singleEventDat.bannerImage == null
                                      ? false
                                      : true,
                                  img: singleEventDat.bannerImage?.mediaPath
                                      .toString(),
                                  title: singleEventDat.eventTitle.toString(),
                                  location: singleEventDat.location,
