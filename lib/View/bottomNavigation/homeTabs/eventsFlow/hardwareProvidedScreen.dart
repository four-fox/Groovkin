...
class HardwareProvidedScreen extends StatelessWidget {
  ...
  List<HardwareProvide> list = [
    ...
    HardwareProvide(
        text: "Club Lighting for Small to Med Room", checkBox: false.obs),
    HardwareProvide(
        text: "Club Lighting for Med to Large Room", checkBox: false.obs),
    HardwareProvide(
        text: "Audio Amplifier and Speakers (Small Room)", checkBox: false.obs),
    HardwareProvide(
        text: "Audio Amplifier and Speakers (Med Room)", checkBox: false.obs),
    HardwareProvide(
        text: "Audio Amplifier and Speakers (Large Room)", checkBox: false.obs),
    HardwareProvide(
        text: "Video  Projector and Screen (5’x8’)", checkBox: false.obs),
    HardwareProvide(
        text: "Video  Projector and Screen (8’x10’)", checkBox: false.obs),
    HardwareProvide(
        text: "Video  Projector and Screen (10’x12’)", checkBox: false.obs),
