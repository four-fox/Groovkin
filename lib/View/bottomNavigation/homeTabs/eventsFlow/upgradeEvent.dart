                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          pictureAlert(
                              context,
                              cameraFtn: () {
                                _authController.cameraImage(context,ImageSource.camera);
                                Get.back();
                              },
                              galleryFtn: () {
                                _authController.cameraImage(context,ImageSource.gallery);
                                Get.back();
                              });
                        },
                        child: Obx(()=> ((_authController.imageLoaders.value==false) || (_authController.imageBytes ==null))?
                        CircleAvatar(
                          ...
                          radius: 60,
                          backgroundImage: FileImage(File(_authController.imageBytes!)),
                        ),
                        )
                      ),
                      SizedBox(
                      ...
                      textFields(theme: theme,labelText: "Featuring",
                      ...
                      textFields(theme: theme,labelText: "About",maxLine: 5,
                      ...
                      textFields(theme: theme,labelText: "Theme of Event",
                          ...
                          if (pickedDate != null) {
                            controller.eventDateController.text =
                                DateFormat('dd-MM-yyyy')
                                    .format(pickedDate);
                            controller.datePost = DateFormat('yyyy-MM-dd')
                                .format(pickedDate);
                          } else {
                        ...
                        onTap: () async {
                          ...
                          if (pickedDate != null) {
                            controller.eventEndDateController.text =
                                DateFormat('dd-MM-yyyy')
                                    .format(pickedDate);
                            controller.endDatePost = DateFormat('yyyy-MM-dd')
                                .format(pickedDate);
                          } else {
                            print("Date is not selected");
                          }
                      ...
                      DateTimeField(
                        ...
                        controller:
                        controller.proposedTimeWindowsController,
                        resetIcon: null,
                        format: format,
                        onShowPicker:
                          ...
                          if(time != null){
                            ...
                            controller.proposedTimeWindowsController.text = DateFormat.jm().format(DateFormat("hh:mm:ss").parse(DateTimeField.convert(time).toString().replaceRange(0, 11, "")));
                            controller.postTime = DateFormat("HH:mm").parse(controller.proposedTimeWindowsController.text).toString().replaceRange(0, 11, "").split(".")[0];
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Theme(
                                ...
                                child: Radio(
                                    activeColor: DynamicColor.yellowClr,
                                    value: 1, groupValue: controller.eventRateHourly.value, onChanged: (v){
                      ...
                      Align(
                        ...
                        child: Text('Select the payment schedule',
                        style: poppinsRegularStyle(
                          context: context,
