              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.hipList[index].text.toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                          context: context),
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          ...
                                          value: controller
                                              .hipList[index].condition!.value,
                                          onChanged: (v) {
                                            controller.hipList[index].condition!
                                                .value = v!;
                                            controller.addForEvent.add(
                                                controller.hipList[index].text);
                                            controller.update();
                                          }),
                                    )
                                  ],
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.soulList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller
                                              .soulList[index].condition!.value,
                                          onChanged: (v) {
                                            controller.soulList[index]
                                                .condition!.value = v!;
                                            controller.addForEvent.add(
                                                controller
                                                    .soulList[index].text);
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.rockList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller
                                              .rockList[index].condition!.value,
                                          onChanged: (v) {
                                            controller.rockList[index]
                                                .condition!.value = v!;
                                            controller.addForEvent.add(
                                                controller
                                                    .rockList[index].text);
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.africanList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller.africanList[index]
                                              .condition!.value,
                                          onChanged: (v) {
                                            controller.africanList[index]
                                                .condition!.value = v!;
                                            controller.addForEvent.add(
                                                controller
                                                    .africanList[index].text);
                                            controller.update();
                                          }),
                                    )
                                  ],
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.latinList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller.latinList[index]
                                              .condition!.value,
                                          onChanged: (v) {
                                            controller.latinList[index]
                                                .condition!.value = v!;
                                            controller.update();
                                          }),
                                    )
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.jazzList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller
                                              .jazzList[index].condition!.value,
                                          onChanged: (v) {
                                            controller.jazzList[index]
                                                .condition!.value = v!;
                                            controller.update();
                                          }),
                                    )
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.countryList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller.countryList[index]
                                              .condition!.value,
                                          onChanged: (v) {
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.danceList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          activeColor: DynamicColor.lightRedClr,
                                          value: controller.danceList[index]
                                              .condition!.value,
                                          onChanged: (v) {
                                            controller.danceList[index]
                                                .condition!.value = v!;
                                            controller.update();
                                          }),
                                    )
                    ...
                    musicGenreWidget(
                      onTap: () {
                        controller.international.value =
                            !controller.international.value;
                        controller.update();
                      },
                      text: "International",
                      theme: theme,
                      context: context,
                      icon: controller.international.value
                          ? Icons.keyboard_arrow_up
                          : Icons.keyboard_arrow_down,
                    ),
                    Padding(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return Row(
                                  children: [
                                    Text(
                                      controller.internationalList[index].text
                                          .toString(),
                                      style: poppinsRegularStyle(
                                          fontSize: 12,
                                          color: theme.primaryColor,
                                    ...
                                    Theme(
                                      ...
                                      child: Checkbox(
                                          ...
                                          value: controller
                                              ...
                                              .value,
                                          onChanged: (v) {
                                            controller.internationalList[index]
                                                .condition!.value = v!;
                                            controller.update();
                                          }),
                                    )
                    ...
                    SizedBox(
                      height: controller.addForEvent.isEmpty
                          ? 0
                          : kToolbarHeight * 1.3,
                    )
                  ],
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(8)),
                                  child: Center(
                                    child: Text(controller.addForEvent[index]
                                        .toString()),
                                  ),
                                ),
                              ),
