...
VenueListModel venueListModelFromJson(String str) =>
    VenueListModel.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        data: json["data"] == null
            ? []
            : List<VenueByLatLng>.from(
                json["data"]!.map((x) => VenueByLatLng.fromJson(x))),
...
class VenueByLatLng {
  ...
  factory VenueByLatLng.fromJson(Map<String, dynamic> json) => VenueByLatLng(
        ...
        houseEventCapabilities: json["house_event_capabilities"] == null
            ? []
            : List<dynamic>.from(
                json["house_event_capabilities"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "house_event_capabilities": houseEventCapabilities == null
            ? []
            : List<dynamic>.from(houseEventCapabilities!.map((x) => x)),
      };
}
