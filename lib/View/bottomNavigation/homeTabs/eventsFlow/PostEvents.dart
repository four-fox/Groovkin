...
class PendingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<EventController>(
      ...
      builder: (controller) {
        return controller.getAllSendingRequestLoader.value==false?SizedBox.shrink():
        controller.allEvents!.data!.data!.isEmpty?Center(
          child: Text("No Data",
          ...
          child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, index){
                EventData eventData = controller.allEvents!.data!.data![index];
            return Padding(
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                              radius: 28,
                              backgroundImage:
                              NetworkImage(eventData.bannerImage == null?eventData.profilePicture![0].mediaPath!: eventData.bannerImage!.mediaPath.toString()),
                          ),
                          Padding(
