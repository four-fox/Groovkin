              ...
              children: [
                ...
                pw.Row(
                  children: [
                    ...
                    pw.Spacer(),
                    pw.Text(
                      controller.eventDetail!.data!.status!.toString(),
                      style: pw.TextStyle(
                        fontSize: 12,
                ...
                pw.Row(
                  children: [
                    ...
                    pw.Spacer(),
                    pw.Text(
                      _controller.eventDetail!.data!.eventTitle!,
                      style: pw.TextStyle(
                        fontSize: 12,
                        fontWeight: pw.FontWeight.normal,
                      ),
                ...
                if (controller.eventDetail!.data!.comment != null)
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Spacer(),
                      pw.Text(
                        controller.eventDetail!.data!.comment!,
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.normal,
                        ),
                ...
                if (controller.eventDetail!.data!.about != null)
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Spacer(),
                      pw.Text(
                        controller.eventDetail!.data!.about!,
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.normal,
                        ),
                ...
                if (controller.eventDetail!.data!.themeOfEvent.toString() !=
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Spacer(),
                      pw.Text(
                        controller.eventDetail!.data!.themeOfEvent!,
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.normal,
                        ),
                ...
                if (controller.eventDetail!.data!.featuring != null ||
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Spacer(),
                      pw.Text(
                        controller.eventDetail!.data!.featuring!,
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.normal,
                        ),
