...
class ChatCenterScreen extends StatelessWidget {
  ChatCenterScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Column(
              children: [
                onGoingVal== "ongoing"?SizedBox.shrink():
                eventOrganizer(theme: theme,context: context,
                    name: "Michael Logan",
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        onGoingVal== "ongoing"?SizedBox.shrink():  Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: CustomButton(
                            heights: 38,
                            style: poppinsRegularStyle(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                            ...
                            suffixIcon: ImageIcon(AssetImage("assets/sendIcon.png"),
                              color: DynamicColor.grayClr,
                            )
                        ),
                      ),
      ...
      bottomNavigationBar: onGoingVal!= "ongoing"?SizedBox.shrink():  Padding(
