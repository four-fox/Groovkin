  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: customAppBar(
          onTap: () {
        Get.back();
      },theme: theme,text: updatedCond==true?"Edit $title":title,style: poppinsMediumStyle(
        fontSize: 17,
        context: context,
      ...
      body: GetBuilder<AuthController>(
        ...
        builder: (controller) {
          return controller.getLifeStyleLoader.value==false?SizedBox.shrink(): Padding(
                        ...
                        itemBuilder: (BuildContext context,index){
                          return Column(
                            children: [
                              ...
                              Padding(padding: EdgeInsets.only(top: 4.0,bottom: 4),
                                child: Visibility(
                                        ...
                                        itemBuilder: (BuildContext context,indexxs){
                                          return Column(
                                            children: [
                                              Row(
                                                children: [
                                                  Text(controller.surveyData!.data![index].categoryItems![indexxs].name!,
                                                    style: poppinsRegularStyle(
                                                        fontSize: 12,color:
                                                    theme.primaryColor,
                                                        context: context
                                                  ...
                                                  Theme(
                                                    ...
                                                    child: Checkbox(
                                                        ...
                                                        value: controller.surveyData!.data![index].categoryItems![indexxs].selectedItem!.value, onChanged: (v){
                                                        controller.surveyAddFtn(surveyObj: controller.surveyData!.data![index],value: v,items: controller.surveyData!.data![index].categoryItems![indexxs]);
                                                    }),
                                                  )
                                                ],
                                              ),
