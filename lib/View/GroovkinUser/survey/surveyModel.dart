...
class SurveyModel {
  ...
  factory SurveyModel.fromJson(Map<String, dynamic> json) => SurveyModel(
    status: json["status"],
    data: json["data"] == null ? [] : List<SurveyObject>.from(json["data"]!.map((x) => SurveyObject.fromJson(x))),
...
class SurveyObject {
  ...
  factory SurveyObject.fromJson(Map<String, dynamic> json) => SurveyObject(
    ...
    eventItems: json["event_items"] == null ? [] : List<EventItem>.from(json["event_items"]!.map((x) => EventItem.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "event_items": eventItems == null ? [] : List<dynamic>.from(eventItems!.map((x) => x.toJson())),
