...
class NotifyScreen extends StatelessWidget {
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              radius: 20,
                              backgroundImage:
                                  AssetImage(list[index].img.toString()),
                            ),
                            Padding(
                              padding:
  ...
  List<NotifyFriends> list = [
    NotifyFriends(
        ...
        img: "assets/deletedImg/friend1.png"),
    NotifyFriends(
        name: "Homies",
        checkBoxVal: false.obs,
        img: "assets/deletedImg/friend2.png"),
    NotifyFriends(
        name: "Fantastic Four",
        checkBoxVal: false.obs,
        img: "assets/deletedImg/friend3.png"),
    NotifyFriends(
        name: "The Squad",
        checkBoxVal: false.obs,
        img: "assets/deletedImg/friend1.png"),
