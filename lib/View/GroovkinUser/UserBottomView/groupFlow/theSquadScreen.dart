...
class TheSquadScreen extends StatelessWidget {
  TheSquadScreen({Key? key}) : super(key: key);
  ...
  child: ListView.builder(
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Align(
          alignment: list[index]==true?Alignment.centerLeft:Alignment.centerRight,
          child: Container(
            width: Get.width/1.4,
...
Align(
  ...
  child:Padding(
          ...
          child:  eventDateWidget(theme: theme,context: context),
                ...
                Padding(
                  padding: EdgeInsets.only(top: 8.0,bottom: 0.0,left: 6.0),
