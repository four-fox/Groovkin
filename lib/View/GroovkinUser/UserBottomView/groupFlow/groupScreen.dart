...
RxBool selectAllValue = false.obs;
  ...
  Widget build(BuildContext context) {
    var theme = Theme.of(context);
    return Scaffold(
      appBar: customAppBar(theme: theme,text: "Create new group",),
      body: Padding(
                ...
                CircleAvatar(
                  ...
                  child: Theme(
                    ...
                    child: Obx(
                          ...
                          value: selectAllValue.value, onChanged: (v){
...
class ViewCreatedGroup extends StatelessWidget {
  const ViewCreatedGroup({Key? key}) : super(key: key);
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Padding(
                ...
                child: Text("Participants 3  ",
                style: poppinsRegularStyle(fontSize: 13,
