...
NearByEventsModel nearByEventsModelFromJson(String str) =>
    NearByEventsModel.fromJson(json.decode(str));

String nearByEventsModelToJson(NearByEventsModel data) =>
...
class NearByEventsModel {
  ...
  factory NearByEventsModel.fromJson(Map<String, dynamic> json) =>
      NearByEventsModel(
        status: json["status"],
