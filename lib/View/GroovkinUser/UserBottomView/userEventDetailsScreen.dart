    ...
    SingleChildScrollView(
      child: Column(
        ...
        children: [
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: theme.primaryColor,),
                          image: DecorationImage(
                            image:controller.eventDetail!.data!.profilePicture![index].mediaPath.toString().split(".").last != "mp4"? NetworkImage(controller.eventDetail!.data != null?controller.eventDetail!.data!.profilePicture![index].mediaPath.toString():'assets/eventPreview.png'):
                            NetworkImage(controller.eventDetail!.data!.profilePicture![index].mediaPath.toString()),
                            fit: BoxFit.fill,
                          )
                      ),
                    ),
              ...
              notifyBtnShow==true? Padding(
                ...
                child: Row(
                  ...
                  children: [
                            ...
                            onTap: (){
                              if(sp.read("role") == 'User'){
                                if(notifyBackBtn == true){
                                  Get.toNamed(Routes.notifyScreen);
                    ...
                    CustomButtonWithIcon(width: 130,height: 30,borderRadius: 6,iconss: Icons.share,iconsClr: DynamicColor.whiteClr,iconValue: false,
                      iconRightSide: true,
                      bgColor: DynamicColor.secondaryClr,
                    ),
                  ],
                ),
              ):Padding(padding: EdgeInsets.only(right: 8,left: 8,bottom: 8),
                child: Row(
                  ...
                  children: [
                    ...
                    CustomButtonWithIcon(width: 130,height: 25,borderRadius: 6,iconss: Icons.share,iconsClr: DynamicColor.whiteClr,iconValue: false,
                      iconRightSide: true,
                      bgColor: DynamicColor.secondaryClr,
                        iconSize: 15,
                      style: poppinsRegularStyle(
          ...
          eventDateTime(theme: theme,context: context,img: "assets/calender.png",text: "${DateFormat.yMMMMEEEEd().format(controller.eventDetail!.data!.startDateTime!)}",iconClr: DynamicColor.yellowClr),
          SizedBox(
            height: 10,
          ),
            ...
            child: Row(
              ...
              children: [
                CustomButton(
                  ...
                  text: "Going",
                  onTap: (){
                    controller.userInterested(eventId: controller.eventDetail!.data!.id,statusValue: "going",);
                  },
                  textClr: DynamicColor.yellowClr,
                ),
                CustomButton(
                  onTap: (){
                    controller.userInterested(eventId: controller.eventDetail!.data!.id,statusValue: "interested",);
                  },
                  borderClr: Colors.transparent,
                  widths: Get.width/2.4,
                  heights: 40,
