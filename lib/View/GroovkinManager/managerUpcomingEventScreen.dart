...
class ManagerUpcomingEventScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: customAppBar(theme: theme,text: "Upcoming", actions: [Icon(Icons.more_vert)]),
      body:
          Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                Container(
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('10:30 Pm to 5:00 Am (GMT-04:00)',
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 4.0),
                          child: Text('Saturday, June 17th of 2023',
                            style: poppinsRegularStyle(
                              fontSize: 13,
                              context: context,
                              color: theme.primaryColor,
                  ...
                  sp.read('role')=="eventManager"?SizedBox.shrink(): Obx(() => aboutEventCreator(horizontalPadding: 0,theme: theme,context: context,
                      followBg:organizerFollowVal.value == true? DynamicColor.grayClr: DynamicColor.lightBlackClr,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        rateAndPriceWidget(theme: theme,context: context,text: "te",value: "22-June-2023"),

                        Divider(
                          color: DynamicColor.grayClr,
                        ),
                        rateAndPriceWidget(theme: theme,context: context,text: "End Date",value: "22-June-2023"),
                        Divider(
                          color: DynamicColor.grayClr,
                        ),
                        rateAndPriceWidget(theme: theme,context: context,text: "Hourly Rate",value: "\$60"),
                        Divider(
                          color: DynamicColor.grayClr,
                        ),
                        rateAndPriceWidget(theme: theme,context: context,text: "Total Rate",value: "\$90"),
                      ],
                    ),
                  ),
                  Obx(() => ourGuestWidget(theme: theme,context: context,horizontalPadding: 0.0,followPadding: 0.0,rowPadding: 0.0,
                    avatarPadding: 8,
                    rowVerticalPadding: 0.0,
                    icon: userVal.value==true?Icons.check:Icons.add,
                    followBgClr: userVal.value==false?DynamicColor.avatarBgClr:DynamicColor.grayClr,
                    textClr:userVal.value==true?theme.scaffoldBackgroundColor: theme.primaryColor,
                    onTap: (){
                  ...
                  Padding(padding: EdgeInsets.only(left: 2,bottom: 8),
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: Text("Herkimer country Faigrounds",
                        style: poppinsMediumStyle(
                            fontSize: 13,
                            context: context,
                            color: theme.primaryColor,
