...
class CreateCompanyProfileScreen extends StatefulWidget {
  ...
  @override
  State<CreateCompanyProfileScreen> createState() => _CreateCompanyProfileScreenState();
}

class _CreateCompanyProfileScreenState extends State<CreateCompanyProfileScreen> {
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              skipBtn == true? SizedBox.shrink():   Align(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                      ...
                      child: DottedBorder(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ((controller.mediaClass.isNotEmpty) || (controller.profilePictures.isNotEmpty))?Align(
                          ...
                          ((editVenue == false) && (controller.mediaClass.isNotEmpty))?
                          SizedBox(
                          ...
                          Image(image: AssetImage("assets/locationIcon.png"),
                        height: 45,
                        width: 45,
                        fit: BoxFit.contain,
                      ):
                              controller.profilePictures.isEmpty?Image(image: AssetImage("assets/locationIcon.png"),
                                height: 45,
                                width: 45,
                                fit: BoxFit.contain,
                              ): SizedBox(
                                ...
                                child: ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                    controller.profilePictures.length,
                                    itemBuilder:
                                        (BuildContext context, index) {
                                      return Stack(
                                        alignment: Alignment.topRight,
                                        children: [
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                      fit: BoxFit
                                                          .fill,
                                                      image:controller.profilePictures[index].mediaFor == null?controller.profilePictures[index].thumbnail ==
                                                          null
                                              ...
                                              child:controller.profilePictures[index].thumbnail !=
                                                ...
                                                onTap: (){
                                                  Get.toNamed(Routes.videoPlayerClass,
                                                      arguments: {
                                                        "type": "filedsaf",
                                                        "url": controller.profilePictures[index].mediaPath
                                                      }
                                                  );
                                                },
                                                child: Center(
                                          ...
                                          GestureDetector(
                                            onTap: (){
                                              controller.removeImgList.add(controller.profilePictures[index].id);
                              ...
                              ((controller.mediaClass.isEmpty) && (controller.profilePictures.isEmpty))? Text("Upload Venue’s Photo",
                                style: poppinsMediumStyle(
                                  context: context,
                                  fontSize: 14,
                    ...
                    controller.lat != "null"? ShowCustomMap(horizontalPadding:0.0,
                    ...
                    Row(
                      children: [
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    CustomButton(
                                                      ...
                                                      onTap: (){
                                                        Get.back();
                                                        controller.termsConditionAgree.value = v!;
                                                        controller.update();
                                                      },
                                                      borderClr: Colors.transparent,
                                                      text: "Agree",
                        ...
                        Padding(
                          ...
                          child: Text("agree to terms and condition",
                          style: poppinsRegularStyle(
                            fontSize: 14,
                            context: context,
                            color: theme.primaryColor,
                      ...
                      onTap: (){
                        if(venueForm.currentState!.validate()){
                          if(controller.termsConditionAgree.value == false){
                            ...
                            if(controller.multiPartImg.isEmpty && editVenue == false){
                              bottomToast(
                                  text: "Please choose venue image"
                              );
                            }else{
