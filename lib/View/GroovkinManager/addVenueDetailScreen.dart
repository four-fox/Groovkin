...
class AddVenueDetailsScreen extends StatelessWidget {
  AddVenueDetailsScreen({Key? key}) : super(key: key);
...
class VenuePermitDetailScreen extends StatelessWidget {
  VenuePermitDetailScreen({Key? key}) : super(key: key);
...
class HouseEventCapabilitiesScreen extends StatefulWidget {
  HouseEventCapabilitiesScreen({Key? key}) : super(key: key);

  @override
  State<HouseEventCapabilitiesScreen> createState() => _HouseEventCapabilitiesScreenState();
}

class _HouseEventCapabilitiesScreenState extends State<HouseEventCapabilitiesScreen> {
  ...
  List<Amenities> list = [
    Amenities(text: "DJ Booth with House Audio controls\No Turntables",checkBoxVel: false.obs),
    Amenities(text: "DJ Booth with House Audio controls\With CD Turntables",checkBoxVel: false.obs),
    Amenities(text: "DJ Booth with House Audio controls\With Vinyl Turntables",checkBoxVel: false.obs),
    Amenities(text: "Live Entertainment License",checkBoxVel: false.obs),
    Amenities(text: "DJ Booth with House Audio controls\With DJ Controller",checkBoxVel: false.obs),
