...
ChatNewUserModel chatNewUserModelFromJson(String str) => ChatNewUserModel.fromJson(json.decode(str));

String chatNewUserModelToJson(ChatNewUserModel data) => json.encode(data.toJson());
...
class ChatNewUserModel {
  ...
  factory ChatNewUserModel.fromJson(Map<String, dynamic> json) => ChatNewUserModel(
    status: json["status"],
