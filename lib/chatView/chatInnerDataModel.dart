...
ChatInnerDataModel chatInnerDataModelFromJson(String str) =>
    ChatInnerDataModel.fromJson(json.decode(str));

String chatInnerDataModelToJson(ChatInnerDataModel data) =>
...
class ChatInnerDataModel {
  ...
  factory ChatInnerDataModel.fromJson(Map<String, dynamic> json) =>
      ChatInnerDataModel(
        status: json["status"],
...
class ChatData {
  ...
  factory ChatData.fromJson(Map<String, dynamic> json) => ChatData(
        ...
        eventRequestAccepted: json["event_request_accepted"].toString(),
        ...
        parentChat: json["parent_chat"] == null
            ? null
            : j.json.encode(ChatData.fromJson(json["parent_chat"])),
        event: json["event"] == null
            ? null
            : j.json.encode(Event.fromJson(json["event"])),
      );
