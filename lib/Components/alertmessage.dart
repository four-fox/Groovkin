...
void alertMethod({title,text,btn,context, childrenData, click, buttonText, titleText, theme}) {
  Get.defaultDialog(
    titlePadding: title==""?EdgeInsets.zero:EdgeInsets.all(8),
      title: title?? 'Update event',
      content:childrenData?? Text(text??
...
class AlertWidget extends StatelessWidget {
  AlertWidget({Key? key,this.container,this.height,this.borderColor,this.radius,
  this.bgColor = false
  }) : super(key: key);
    ...
    return AlertDialog(
      ...
      content: Container(
        ...
        borderRadius: BorderRadius.circular(radius??15),
            border: Border.all(color: borderColor?? DynamicColor.grayClr.withOpacity(0.5)),
            image:bgColor==false? DecorationImage(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(btnSuccess.toString(),
                      style: poppinsMediumStyle(
                          fontSize: 16,
                          color: DynamicColor.whiteClr),
                    ),
